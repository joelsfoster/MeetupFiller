...
const Index = () => (
  <div className="index">
    <Jumbotron className="text-center">
      <h2>Every empty Meetup spot is costing you money.</h2>
      <p>MeetupFiller detects when you have upcoming unfilled Meetups, and automatically sends discounts to members to get those spots filled.</p>
