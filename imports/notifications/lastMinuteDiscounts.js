...
export const lastMinuteDiscounts = (recipient, price, eventName, discountID) => {
  ...
  const email = (recipient, price, eventName, discountID) => {
    Email.send({
      ...
      html: "<p>We have last-minute openings available, and we're offering a special discount!</p><p><a href='https://www.meetupfiller.com/rsvp-payment/" + discountID + "'>$" + price + " - " + eventName + "</a></p><p><i>Please note that this discount can only be processed through this link, and we cannot nor will not honor the discount if you book directly through Meetup. By paying through this portal, you agree to the organization's Refund Policy.</i></p>Hope to see you there!<br />PS2G<br /><i><a href='https://www.playsoccer2give.com'>Local Games for Global Change</a></i><br /><br /><p><img src='a248.e.akamai.net/secure.meetupstatic.com/photos/event/5/e/d/0/highres_258204272.jpeg' height='100'></p>",
    });
  }
